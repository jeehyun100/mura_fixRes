...
from effi_b7_metric_learning import TrainerConfig, ClusterConfig, Trainer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch', default=24, type=int, help='Batch by GPU')
    ...
    parser.add_argument('--output-dir', default='./plots/', help='plot dir')
