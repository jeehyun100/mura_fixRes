...
from dense156_scratch import TrainerConfig, ClusterConfig, Trainer
...
if __name__ == "__main__":
    ...
    parser.add_argument('--job-id', default='dense_elb_wnor_pad_wrot_wmorpo_hi_h7_pre_s', type=str, help='id of the execution')
    ...
    parser.add_argument('--mura_part',  type=str, default="ALL", help='type of mura dataset')# #'ALL XR_ELBOW', 'XR_FINGER', 'XR_FOREARM', 'XR_HAND', 'XR_HUMERUS', 'XR_SHOULDER', 'XR_WRIST']
