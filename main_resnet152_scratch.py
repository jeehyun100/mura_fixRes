...
def run(input_sizes,learning_rate,epochs,batch,node,workers,imnet_path,shared_folder_path,job_id,local_rank,global_rank,num_tasks, data_root, train_image_paths, test_image_paths, weight_path=''):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch', default=12, type=int, help='Batch by GPU')
